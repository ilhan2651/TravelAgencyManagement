...
namespace Tam.Api.Controllers
{
    ...
    public class HotelRoomOptionController(IHotelRoomOptionService service) : ControllerBase
    {
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] CreateHotelRoomOptionDto dto)
        {
        ...
        [HttpPut("update/{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] UpdateHotelRoomOptionDto dto)
        {
