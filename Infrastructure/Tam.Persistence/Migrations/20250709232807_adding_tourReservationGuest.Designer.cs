...
namespace Tam.Persistence.Migrations
{
    ...
    [Migration("20250709232807_adding_tourReservationGuest")]
    partial class adding_tourReservationGuest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tam.Domain.Entities.HotelReservationRoomOption", b =>
                {
                    ...
                    b.Property<int>("HotelRoomOptionId")
                        .HasColumnType("integer");

                    b.Property<int>("Quantity")
                        .HasColumnType("integer");

                    b.HasKey("HotelReservationId", "HotelRoomOptionId");

                    b.HasIndex("HotelRoomOptionId");

                    b.ToTable("HotelReservationRoomOptions");
                });

            modelBuilder.Entity("Tam.Domain.Entities.HotelRoomOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.DiscountHotel", b =>
                {
                    b.Property<int>("DiscountId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.DiscountTour", b =>
                {
                    b.Property<int>("DiscountId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.DiscountTransfer", b =>
                {
                    b.Property<int>("DiscountId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.DriverLocation", b =>
                {
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.DriverTransfer", b =>
                {
                    b.Property<int>("DriverId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.GuideLanguage", b =>
                {
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.GuideLocation", b =>
                {
                    b.Property<int>("GuideId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.GuideRegion", b =>
                {
                    b.Property<int>("GuideId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.HotelFacility", b =>
                {
                    b.Property<int>("HotelId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.RouteStop", b =>
                {
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.TourDriver", b =>
                {
                    b.Property<int>("TourId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.TourHotel", b =>
                {
                    b.Property<int>("TourId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.TourRegion", b =>
                {
                    b.Property<int>("TourId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.TourVehicle", b =>
                {
                    b.Property<int>("TourId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.TransferVehicle", b =>
                {
                    b.Property<int>("TransferId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.JoinTables.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.RoomType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tam.Domain.Entities.TourReservationGuest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TourReservationGuests");
                });
            ...
            modelBuilder.Entity("Tam.Domain.Entities.TransferReservationGuest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("transferReservationGuests");
                });
            ...
            modelBuilder.Entity("Tam.Domain.Entities.HotelReservationRoomOption", b =>
                {
                    ...
                    b.HasOne("Tam.Domain.Entities.HotelRoomOption", "HotelRoomOption")
                        .WithMany()
                        .HasForeignKey("HotelRoomOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HotelReservation");

                    b.Navigation("HotelRoomOption");
                });
            ...
            modelBuilder.Entity("Tam.Domain.Entities.HotelRoomOption", b =>
                {
                    ...
                    b.HasOne("Tam.Domain.Entities.RoomType", "RoomType")
                        .WithMany("HotelRoomOptions")
            ...
            modelBuilder.Entity("Tam.Domain.Entities.TransferReservationGuest", b =>
                {
                    b.HasOne("Tam.Domain.Entities.TransferReservation", "TransferReservation")
                        .WithMany("Guests")
                        .HasForeignKey("TransferReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
